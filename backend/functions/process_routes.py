...
def get_type(merged_data:str, bus_type_map:dict, return_routes:dict, city:str):
...
def process_and_save_routes():
    ...
    try:
        ...
        # 處理台北市公車資料
        get_type(merged_data, bus_type_map, all_routes, "taipei")

        # 處理新北市公車資料
        get_type(merged_data, bus_type_map, all_routes, "newtaipei")
